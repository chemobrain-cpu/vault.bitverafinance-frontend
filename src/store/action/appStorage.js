...
export const checkIfIsLoggedIn = () => async (dispatch) => {
  ...
  try {
    ...
    const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/userbytoken`, {
      method: 'GET',
      headers: {
...
export const login = (data) => {
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://vault-bitverafinance-backend.onrender.com/login', {
        method: "POST",
...
export const signup = (data) => {
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://vault-bitverafinance-backend.onrender.com/signup', {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(data),
      });
...
export const verifyEmail = (data) => {
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://vault-bitverafinance-backend.onrender.com/verifyemail', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const registeration = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/registeration`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const profilePhoto = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/pofilephoto`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const fetchTrade = (user) => {
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://vault-bitverafinance-backend.onrender.com/tradess', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const changeCurrency = (data) => {
  return async (dispatch, getState) => {
    try {
      let response = await fetch('https://vault-bitverafinance-backend.onrender.com/changecurrency', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const createDeposit = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/createdeposit`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const fetchDeposit = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/fetchdeposit`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const fetchWithdraw = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/fetchwithdraw`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const createWithdraw = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/createwithdraw`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const fetchPackages = (data) => {
  return async (dispatch, getState) => {
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/packages`, {
        headers: {
          "Content-Type": "application/json",
        }
      })
...
export const fetchInvestment = (id) => {
  return async (dispatch, getState) => {
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/investment/${id}`, {
        headers: {
          "Content-Type": "application/json",
        }
      })
...
export const fetchDepositHandler = (userId) => {
  return async (dispatch, getState) => {
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/fetch-handlers/${userId}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json',
        },
...
export const  createPay = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/createpay`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const  updatePassword = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://vault-bitverafinance-backend.onrender.com/update-password`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
